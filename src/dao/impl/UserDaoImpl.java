...
public class UserDaoImpl implements UserDao {
	...
	public void add(User user){
		try{
			...
			String sql = "insert into TB_BOOKSTORE_user(id,username,password,phone,cellphone,address,email) values(?,?,?,?,?,?,?)";
	...
	public User find(String id){
		try{
			QueryRunner runner = new QueryRunner(JdbcUtils.getDataSource());
			String sql = "select * from TB_BOOKSTORE_user where id=?";
	...
	public User find(String username, String password){
		try{
			QueryRunner runner = new QueryRunner(JdbcUtils.getDataSource());
			String sql = "select * from TB_BOOKSTORE_user where username=? and password=?";
