...
<html>
  ...
  <body style="text-align:center;">
    <h2>订单列表</h2>
    <table width="80%" border="1" align="center" style="text-align: center;" id="trcolor" >
    	<tr>
    		<td bgcolor="#A3E6DF" class="tableopentd01">订单号</td>
    		<td bgcolor="#A3E2E6" class="tableopentd01">订单人</td>
    		<td bgcolor="#A3D7E6" class="tableopentd01">订单时间</td>
    		<td bgcolor="#A3CCE6" class="tableopentd01">订单总价</td>
    		...
    		<tr>
	    		...
	    		<td>${order.price }</td>
	    		<td>${order.state eq 'True1' ?"已发货":"未发货" }</td>
	    		<td>
