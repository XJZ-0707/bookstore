...
<html>
  ...
  <body style="text-align:center;">
    ...
    <table border="1" width="80%" align="center" style="text-align: center;">
    	<tr>
    		<td bgcolor="#A3E6DF">书名</td>
    		<td bgcolor="#A3D7E6">售价</td>
    		<td bgcolor="#A3CCE6">数量</td>
    		<td bgcolor="#A3B6E6">应收货款</td>
    	</tr>
    ...
    <h3>收货人详细信息</h3>
    <table border="1" width="85%" align="center" style="text-align: center;">  
    	<tr>
    		<td bgcolor="#A3E6DF">用户</td>
    		<td bgcolor="#A3D7E6">电话</td>
    		<td bgcolor="#A3CCE6">手机</td>
    		<td bgcolor="#A3B6E6">地址</td>
    		<td bgcolor="#A3B6E6">邮箱</td>
    	</tr>
    	<tr>
